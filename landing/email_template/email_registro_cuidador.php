<div style="width: 600px;  margin:auto auto; font-size: 18px;	">
	...
	<div style="text-align: center;background:#00d8b5; color: #fff; width: 100%; padding: 10px 0px 10px 0px; text-align: left;">
		...
		<img src="/wp-content/uploads/2017/02/logo-kmimos.png" alt="logo-kmimos" style="float: right;margin-right:15px;">
	</div>
		...
		<div style="color:#9c9c9c;width: 370px; float:left; padding:5px 5px 5px 5px; font-size: 14px; text-align: justify;">
			...
			<div style="clear: both; width: 100%;">				
				<div  style="float:left; width: 100px; text-align:center; padding: 0px; margin:0px;">
					<img style="margin:auto;" width="60%" src="/landing/img/persona.jpg">
				</div>
			...
			<div style="clear: both; width: 100%;">				
				<div  style="float:left; width: 100px; text-align:center; padding: 0px; margin:0px;">
					<img style="margin:auto;" width="60%" src="/landing/img/arbol.jpg">
				</div>
				<p style="float:right; width: 250px;">
			...
			<div style="clear: both; width: 100%;">				
				<div  style="float:left; width: 100px; text-align:center; padding: 0px; margin:0px;">
					<img style="margin:auto;" width="60%" src="/landing/img/perro.jpg">
				</div>
				<p style="float:right; width: 250px;">
			...
			<div style="clear: both; width: 100%;">				
				<div  style="float:left; width: 100px; text-align:center; padding: 0px; margin:0px;">
					<img style="margin:auto;" width="60%" src="/landing/img/perro2.jpg">
				</div>
				<p style="float:right; width: 250px;">
			...
			<div style="text-align: center; ">
				<ul class="list-inline " style="color: #737272;font-weight: 700;">
					<li style="list-style:none;width: 25%;float:left;position: relative;min-height: 1px;">
						<img class="hidden-sm hidden-xs" src="/wp-content/themes/pointfinder/images/1_complado.png" class="img-responsive" style="margin:auto;" width="150px">
						<br><span>Registrarte y describirte<span><br><br>
					</li>
					<li style="list-style:none;width: 25%;float:left;position: relative;min-height: 1px;" >
						<img class="hidden-sm hidden-xs" src="/wp-content/themes/pointfinder/images/2_complado.png" class="img-responsive" style="margin:auto;" width="150px">
						<br><span>Enviar documentos<span><br><br>
					</li>
					<li style="list-style:none;width: 25%;float:left;position: relative;min-height: 1px;">
						<img class="hidden-sm hidden-xs" src="/wp-content/themes/pointfinder/images/3_complado.png" class="img-responsive" style="margin:auto;" width="150px">
						<br><span>Realizar tus pruebas<span><br><br>
					</li>
					<li style="list-style:none;width: 25%;float:left;position: relative;min-height: 1px;">
						<img class="hidden-sm hidden-xs" src="/wp-content/themes/pointfinder/images/4_complado.png" class="img-responsive" style="margin:auto;" width="150px">
			...
			<div style="border-radius:10px; border:1px solid #ccc;width: 87%;margin: auto;">
				<ul class="list-inline">
					<li style="list-style:none;width: 150px;float:left;position: relative;" >
						<img src="/wp-content/themes/pointfinder/images/girl.png" class="img-responsive" width="150px"	>
					</li>
