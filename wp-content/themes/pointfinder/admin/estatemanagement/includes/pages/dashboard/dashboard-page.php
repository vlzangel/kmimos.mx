...
*/
					...
					**/
					...
					switch ($ua_action) {
						...
						case 'updateservices':
	                        ...
	                        $hospedaje = array(
								"pequenos" => $_POST['hospedaje_pequenos'],
								"medianos" => $_POST['hospedaje_medianos'],
								"grandes"  => $_POST['hospedaje_grandes'],
								"gigantes" => $_POST['hospedaje_gigantes']
							);
	      ...
	      //                   echo "</pre>";
                        	...
                        	global $wpdb;
	                        $sql = "UPDATE cuidadores SET adicionales = '".serialize($adicionales)."' WHERE user_id = ".$user_id.";";
	                        $wpdb->query($sql);
        ...
        //                     echo '<h1 style="margin-top: 0px;">Mis Reservas Pendientes</h1><hr>';
                        ...
                        case 'mybooking':
                         ...
                         case 'mypicturesdel':
                         	try{
	                         	if(isset($_GET['p'])){
	                         		$name_folder = $user_id - 5000;
	                         		$fullpath = realpath("wp-content/uploads/cuidadores/galerias/".$name_folder."/".$_GET['p']);
                 			...
                 			<br><p>Redireccionando a Mis Fotos</p>';
