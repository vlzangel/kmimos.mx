	...
	/*Jauregui*/
		$('#pf-ajax-profileupdate-button').on('click touchstart',function(){
			...
			if ($.isEmptyObject($.pfAjaxUserSystemVars4)) {
				...
				$.pfAjaxUserSystemVars4.email_err = 'Debe Ingressar una direction de Correo';
				$.pfAjaxUserSystemVars4.email_err2 = 'Su direction de correo debe ser nombre@dominio.com';
				$.pfAjaxUserSystemVars4.nickname_err = 'Por favor escriba un Nombre de Unsuario';
			...
			form.validate({ 
				  ...
				  messages:{
				  	...
				  	referred:{
						required:"Debe colocar de Donde nos Conció"
				  	},
				  	user_state:{
				  		maxlength:"Por favor, no escribas más de {0} caracteres.",
				  	...
				  	webaddr:{
				  	 ...
				  	 twitter:{
				      url: "Ingrese una Dirección de TwitterVálida"
				    },
				    facebook:{
				      url: "Ingrese una Dirección de Facebook Válida"
				    },
				    googleplus:{
				      url: "Ingrese una Dirección de Googleplus Válida"
				    },
				    linkedin:{
				      url: "Ingrese una Dirección de Linkedin Válida"
				    },
				  	...
				  	nickname:{
					  	...
					  	maxlength:"Por favor, introduzca máximo 12 caracteres por el apodo."
				  	},
				  	password: {
						pattern:"Contraseña Invalida",
						maxlength: $.pfAjaxUserSystemVars4.passwd_err
