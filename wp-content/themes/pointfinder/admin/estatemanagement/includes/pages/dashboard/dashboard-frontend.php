						...
						**/
                        ...
                        foreach ($precios_hospedaje as $key => $value) {
                        	$hospedaje .= "
                        		<div class='vlz_celda_25'>
                        			<label>".$tam[$key]."</label>
                        			<input type='number' class='vlz_input' id='hospedaje_".$key."' name='hospedaje_".$key."' value='".$value."' />
                    			</div>
                        	";
                        }
                        ...
                        foreach ($adicionales_extra as $key => $value) {
                        	$adicionales_extra_str .= "
                        		<div class='vlz_celda_20'>
                        			<label>".$value."</label>
                        			<input type='number' class='vlz_input' id='adicional_".$key."' name='adicional_".$key."' value='".$adicionales[$key]."' />
                    			</div>
                        	";
                        }
                    	...
                    	foreach ($rutas as $slug => $valor) {
                    		$temp .= "
                        		<div class='vlz_celda_33'>
                        			<label>".$valor."</label>
                        			<input type='number' class='vlz_input' id='transportacion_sencilla_".$slug."' name='transportacion_sencilla_".$slug."' value='".$adicionales['transportacion_sencilla'][$slug]."' />
                    			</div>
                			";
                    	}
                    	$transporte_sencillo_str .= "
                    	...
                    	foreach ($rutas as $slug => $valor) {
                    		$temp .= "
                        		<div class='vlz_celda_33'>
                        			<label>".$valor."</label>
                        			<input type='number' class='vlz_input' id='transportacion_redonda_".$slug."' name='transportacion_redonda_".$slug."' value='".$adicionales['transportacion_redonda'][$slug]."' />
                    			</div>
                			";
                    	}
                    	$transporte_redondo_str .= "
