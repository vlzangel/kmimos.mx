				...
				switch ($params['formtype']) {
					...
					case 'myshop':
						...
						**/
                        ...
                        $petsitter = kmimos_get_petsitter_info($user_id);

                        $petsitter_id = $petsitter['petsitter_id'];
                        $lat = get_post_meta( $petsitter_id, 'latitude_petsitter',true );
                        $lng = get_post_meta( $petsitter_id, 'longitude_petsitter',true );

                        // $user = get_user_meta($petsitter['user_petsitter']);
                        ...
                        $this->FieldOutput .= '<div class="tienda_cuidador" data-petsitter="'.$petsitter_id.'">';
                        $this->FieldOutput .= '<h3>Foto de Portada</h3><br>';
                        $imagen = get_the_post_thumbnail($petsitter_id, array(800,450));
                        if($imagen == '') $imagen = '<img src="'.get_template_directory_uri().'/images/noimg.png">';
                        $this->FieldOutput .= '<section>
		                                    <label for="userphoto" class="lbl-text">'.esc_html__('Foto de portada (Recomendado:800px/450px Ancho/Alto)','pointfindert2d').' (.jpg, .png, .gif):</label>
		                                    ...
		                                    <span class="goption">
				                                ...
				                                <label for="check1">'.esc_html__('Eliminar foto de portada','pointfindert2d').'</label>
				                           </span>
		                               		</div>
		                ...
		                $this->FieldOutput .= '     
		                               <section>
		                                    <label for="shop_description" class="lbl-text">'.esc_html__('Descripción del Servicio Ofrecido','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                    	<textarea name="shop_description" class="textarea">'. $petsitter['description'].'</textarea>
		                                    </label>                          
		                               </section>
		                               <input  type="hidden" name="shop_address" class="input" value="x" />
		                               <input  type="hidden" name="shop_sector" class="input" value="x" />
		                               ';
		                               /*
		                $this->FieldOutput .= '     
		                          <div class="cell50">
		                               <section>
		                                    <label for="shop_address" class="lbl-text">'.esc_html__('Ciudad','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                    	<input  type="text" name="shop_address" class="input" value="'.$petsitter['address_petsitter'].'" />
		                                    </label>                          
                                       </section>                          
		                          </div>';
		                $this->FieldOutput .= '     
		                          <div class="cell50">
                                        <section>
		                                    <label for="shop_sector" class="lbl-text">'.esc_html__('Localidad','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                    	<input  type="text" name="shop_sector" class="input" value="'.$petsitter['sector_petsitter'].'" />
		                                    </label>
                                       </section>                          
		                          </div>';
		                          */
		                ...
		                $this->FieldOutput .= '
		                          <div style="display: none;">     
                                       <section>
		                                    <label for="shop_zip" class="lbl-text">'.esc_html__('Código Postal','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                    	<input type="text" name="shop_zip" class="input" value="0" />
		                                    </label>                          
                                       </section>                          
		                          </div>';
		                			...
		                			$this->FieldOutput .= '     
		                          	<div class="cell50">     
                                       <section>
		                                    ...
		                                    <label class="lbl-ui">
		                                    	<select name="shop_type" class="input">';
                        							$tipo =($petsitter['housing_petsitter']==1)? ' selected':''; $this->FieldOutput .= '
                                                    <option value="1"'.$tipo.'>Casa</option>';
                        							$tipo =($petsitter['housing_petsitter']==2)? ' selected':''; $this->FieldOutput .= '
                                                    <option value="2"'.$tipo.'>Departamento</option>
                                                </select>
		                                    </label>                          
                                       </section>                          
		                          	</div>';

			                        $greens =($petsitter['greens_petsitter']==1)? ' checked':'';
			                        $yard =($petsitter['yard_petsitter']==1)? ' checked':'';

		                			$this->FieldOutput .= '     
		                          	<div class="cell50 derecha">
	                                	<label for="shop_details" class="lbl-text">'.esc_html__('Detalles de la Propiedad', 'pointfindert2d').':</label>
			                          	<div class="clearfix" style="margin-bottom:10px"></div>
	                                  	<div class="cell50">     
	                                       	<section>
			                                    <span class="goption">
					                                <label class="options">
					                                    <input type="checkbox" name="shop_green" value="1"'.$greens.'>
					                                    <span class="checkbox"></span>
					                                </label>
					                                <label for="shop_green">'.esc_html__('Posee Áreas Verdes','pointfindert2d').'</label>
					                           </span>
	                                       	</section>                          
			                          	</div>    
			                          	<div class="cell50">     
	                                       	<section>
			                                    <span class="goption">
					                                <label class="options">
					                                    <input type="checkbox" name="shop_yard" value="1"'.$yard.'>
					                                    <span class="checkbox"></span>
					                                </label>
					                                <label for="shop_yard">'.esc_html__('Posee Patio','pointfindert2d').'</label>
					                           </span>
	                                       	</section>                          
			                          	</div>                          
		                          		<div class="clearfix" style="margin-bottom:10px"></div>
		                			...
		                			$this->FieldOutput .= '     
		                               <section>
											...
											<input type="number" class="geolocation" id="latitude_petsitter" name="latitude_petsitter" placeholder="Latitud" step="any" value="'. $petsitter['latitude_petsitter'].'" />
											<input type="number" class="geolocation" id="longitude_petsitter" name="longitude_petsitter" placeholder="Longitud" step="any" value="'. $petsitter['longitude_petsitter'].'" />
		                               </section>';

			                        $cachorros =($petsitter['pets_puppies']==1)? ' checked':'';
			                        $adultos =($petsitter['pets_adults']==1)? ' checked':'';
			                        $seniors =($petsitter['pets_seniors']==1)? ' checked':'';

		                			$this->FieldOutput .= '     
		                          	<div class="col4 first roles">     
		                               <section>
		                                    <label for="ages_accepted" class="lbl-text">'.esc_html__('Edades Aceptadas','pointfindert2d').':</label>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="puppies_accepted" value="1"'.$cachorros.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="puppies_accepted">'.esc_html__('Cachorros','pointfindert2d').'</label>
				                           </span>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="adults_accepted" value="1"'.$adultos.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="adults_accepted">'.esc_html__('Adultos','pointfindert2d').'</label>
				                           </span>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="seniors_accepted" value="1"'.$seniors.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="seniors_accepted">'.esc_html__('Seniors','pointfindert2d').'</label>
				                           </span>
                                       </section>                          
		                          	</div>';

			                        $machos =($petsitter['pets_males']==1)? ' checked':'';
			                        $hembras =($petsitter['pets_females']==1)? ' checked':'';
			                        $esteriles =($petsitter['pets_sterilized']==1)? ' checked':'';

		                			$this->FieldOutput .= '     
		                          	<div class="col4 first">     
		                               <section>
		                                    <label for="genders_accepted" class="lbl-text">'.esc_html__('Géneros Aceptados','pointfindert2d').':</label>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="males_accepted" value="1"'.$machos.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="males_acepted">'.esc_html__('Machos','pointfindert2d').'</label>
				                           </span>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="females_accepted" value="1"'.$hembras.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="females_acepted">'.esc_html__('Hembras','pointfindert2d').'</label>
				                           </span>
		                                    <span class="goption col12">
				                                <label class="options">
				                                    <input type="checkbox" name="only_sterilized" value="1"'.$esteriles.'>
				                                    <span class="checkbox"></span>
				                                </label>
				                                <label for="only_sterilized">'.esc_html__('Solo Mascotas Esterilizadas','pointfindert2d').'</label>
				                           </span>
                                       </section>                          
		                          	</div>';
			                        $nosociables =($petsitter['pets_unsociable']==1)? ' checked':'';
			                        $agrehumanos =($petsitter['aggressive_with_humans']==1)? ' checked':'';
			                        $agremascotas =($petsitter['aggressive_with_pets']==1)? ' checked':'';
					                $this->FieldOutput .= '     
		                         	 	<div class="col4 first">     
			                               	<section>
			                                    ...
			                                    <span class="goption col12">
					                                <label class="options">
					                                    <input type="checkbox" name="not_sociables" value="1"'.$nosociables.'>
					                                    <span class="checkbox"></span>
					                                </label>
					                                <label for="not_sociables">'.esc_html__('No Sociables','pointfindert2d').'</label>
					                           </span>
			                                    <span class="goption col12">
					                                <label class="options">
					                                    <input type="checkbox" name="aggresive_humans" value="1"'.$agrehumanos.'>
					                                    <span class="checkbox"></span>
					                                </label>
					                                <label for="aggresive_humans">'.esc_html__('Agresivos con Humanos','pointfindert2d').'</label>
					                           </span>
			                                    <span class="goption col12">
					                                <label class="options">
					                                    <input type="checkbox" name="aggresive_pets" value="1"'.$agremascotas.'>
					                                    <span class="checkbox"></span>
					                                </label>
					                                <label for="aggresive_pets">'.esc_html__('Agresivos con otras Mascotas','pointfindert2d').'</label>
					                           	</span>
	                                       	</section>                          
			                          	</div>
			                        ...
			                        $servicios = array(
			                            'pequeno'=>'<p>Pequeño (0 - 10Kg)</p>', 
			                            'mediano'=>'<p>Mediano (11 - 25Kg)</p>', 
			                            'grande'=>'<p>Grande (26 - 45Kg)</p>', 
			                            'gigante'=>'<p>Gigante (+46Kg)</p>'
			                        );

			                        $tama = unserialize(unserialize($petsitter['sizes_pets']));
		                         	 	...
		                         	 	<div class="col4 first">     
			                               	<section>
			                                    ...
			                                    foreach ($servicios as $key => $value) {
			                                    	$check = ($tama[$cot] == 1) ? ' checked' : '';
			                                    	$this->FieldOutput .= '<span class="goption col12">
						                                <label class="options">
						                                    <input type="checkbox" name="'.$key.'" value="1" '.$check.'>
						                                    <span class="checkbox"></span>
						                                </label>
			                        ...
			                        $tama = unserialize(unserialize($petsitter['home_pets']));

					                $this->FieldOutput .= '     
		                         	 	<div class="col4 first">     
			                               	<section>
			                                    <label for="behavior_accepted" class="lbl-text">'.esc_html__('# de mascotas en casa','pointfindert2d').':</label>
			                                    <label for="pets_petsitter"><input type"text" name="pets_petsitter" class="input" value="'.$petsitter['pets_petsitter'].'"></label>
			                                    <br><label><b>Sus tama&ntilde;os:</b><br></label>';
			                                    $cot = 0;
			                                    foreach ($servicios as $key => $value) {
			                                    	$check = ($tama[$cot] == 1) ? ' checked' : '';
			                                    	$this->FieldOutput .= '<span class="goption col12">
						                                <label class="options">
						                                    <input type="checkbox" name="tengo_'.$key.'" value="1" '.$check.'>
						                                    <span class="checkbox"></span>
						                                </label>
						                                <label for="tengo_'.$key.'">'.$value.'</label>
						                           </span>';
						                           $cot++;
			                                    }
					                           	$this->FieldOutput .= '
					                ...
					                $this->FieldOutput .= '     
		                         	 	<div class="col4 first">     
			                               	<section>
			                                    <label for="behavior_accepted" class="lbl-text">'.esc_html__('# de perros aceptados','pointfindert2d').':</label>
			                                    <label for="mascotas_hospedaje"><input type"text" name="mascotas_hospedaje" class="input" value="'.$petsitter['mascotas_hospedaje'].'"></label>
	                                       	</section>                          
			                          	</div>
			                          	<div class="clearfix" style="margin-bottom:10px"></div><br>';

		                			$this->FieldOutput .= '     
		                          	<div class="cell50">
		                               <section>
		                                    <label for="video_youtube" class="lbl-text">'.esc_html__('Video de Youtube','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                    	<input  type="text" name="video_youtube" class="input" value="'.$petsitter['video_youtube'].'" />
		                                    </label>                          
                                       </section>                          
		                          	</div>';
			                        $this->ScriptOutput .= '
									      function initMap() {
									        var uluru = {lat: '.$lat_def.', lng: '.$lng_def.'};
									        ...
									        google.maps.event.addListener(marker, "dragend", function(){
									            document.getElementById("latitude_petsitter").value = marker.getPosition().lat();
									            document.getElementById("longitude_petsitter").value = marker.getPosition().lng();
									        });
									      }      
									';
								break;
...
//print_r($current_pet);
                        ...
                        $this->FieldOutput .= '
                                   <div class="cell50">
		                               <section>
		                                    ...
		                                    <label class="lbl-ui">
		                                    	<!--<select type="text" name="pet_breed" class="input" value="'.$current_pet['breed'].'" />-->
		                                    	<select type="text" name="pet_breed" class="input" value="'.$current_pet['breed'].'" />
		                                    		<option value="">Favor Seleccione</option>';

			                                    	foreach ($this->razas as $key => $value) {
			                                    		$this->FieldOutput .= '<option value="'.$value.'">'.$value.'</option>';
			                                    	}
                        ...
                        foreach ( $generos as $genero ) {
                            ...
                            if($genero['ID'] == $current_pet['gender']) $this->FieldOutput .= ' ';
                        ...
                        foreach ( $tamanos as $tamano ) {
                            ...
                            if($tamano['ID'] == $current_pet['size']) $this->FieldOutput .= '';
                        ...
                        for ( $i=0; $i<count($si_no); $i++ ) {
                            ...
                            if($i == (int)$current_pet['sterilized']) $this->FieldOutput .= ' ';
                        ...
                        for ( $i=0; $i<count($si_no); $i++ ) {
                            $this->FieldOutput .= '<option value="'.$i.'"';
                            if($i == (int)$current_pet['sociable']) $this->FieldOutput .= ' ';
                            $this->FieldOutput .= '>'.$si_no[$i].'</option>
                            ';
                        }
                        $this->FieldOutput .= '
                        ...
                        for ( $i=0; $i<count($si_no); $i++ ) {
                            $this->FieldOutput .= '<option value="'.$i.'"';
                            if($i == (int)$current_pet['aggresive_humans']) $this->FieldOutput .= ' ';
                            $this->FieldOutput .= '>'.$si_no[$i].'</option>
                            ';
                        }
                        $this->FieldOutput .= '
                        ...
                        for ( $i=0; $i<count($si_no); $i++ ) {
                            $this->FieldOutput .= '<option value="'.$i.'"';
                            if($i == (int)$current_pet['aggresive_pets']) $this->FieldOutput .= ' ';
                            $this->FieldOutput .= '>'.$si_no[$i].'</option>
                            ';
                        }
                        $this->FieldOutput .= '
                        ...
                        $this->FieldOutput .= '     
		                               <section>
		                                    ...
		                                    <label class="lbl-ui">
		                                    	<textarea name="pet_observations" class="textarea">'. $petsitter['observations'].'</textarea>
		                                    </label>';
                        if($_GET['ua']=='mypet') $this->FieldOutput .= '
		                                    <label for="delete_pet" class="lbl-text" style="float: right;">
...
//                       $this->ScriptOutput = 'jQuery(".datepicker").datepicker();';
					...
					case 'mybookings':
						...
						**/
                        $buttonid = 'pf-ajax-add-booking-button';
                        $buttontext = esc_html__('AGREGAR RESERVA','pointfindert2d');
                        $user_id = $current_user->ID;
                        $count = ($params['count']!='')? $params['count']: 0;

                        $this->FieldOutput .= '<div class="lista_reservas" data-user="'.$user_id.'"><ul>';
                        if($count>0) {
                            $bookings = explode(",",$params['list']);
                            $this->FieldOutput .= '<div class="inside">';
                            $this->FieldOutput .= '<ul>';
                            foreach($bookings as $booking){ 
                                $this->FieldOutput .= '<li><a href="'.$params['detail_url'].$booking.'">'. get_the_title($booking).'</a></li>';
                            }
                            $this->FieldOutput .= '</ul>';
                            $this->FieldOutput .= '<br><p>Total: '.count($bookings).' reservas</p>';
                            $this->FieldOutput .= '</div>';
                        }
                        else $this->FieldOutput .=  '<p>No tienes ninguna reserva en curso</p>';
                        $this->FieldOutput .=  '</ul><br></div>';
						/**
						*End: Bookings list Page Content
						**/
						break;
						...
						**/
                        ...
                        if($service_id!='') {
                            ...
                            foreach ($tamanos as $key => $value) {
                            	$precio = $metas["precio_{$servicio}_{$i}"][0];
					...
					case 'myservices':
						...
						**/
                        $formaction = 'pfadd_new_service';
                        $noncefield = wp_create_nonce($formaction);
                        $buttonid = 'pf-ajax-add-service-button';
                        $buttontext = esc_html__('AGREGAR SERVICIO','pointfindert2d');
                        $user_id = $current_user->ID;
                        $count = ($params['count']!='')? $params['count']: 0;
                        ...
                        jQuery('#pf-ajax-add-service-button').on('click',function(e){
                            e.preventDefault();
                            jQuery('#pfuaprofileform').attr('action','?ua=newservice');
                            jQuery('#pfuaprofileform').submit();
                        });
                        ";
						/**
					...
					case 'mypictures':
						...
						**/
                            ...
                            $this->FieldOutput .= '<div class="lista_fotos" data-user="'.$user_id.'"><ul>';
                            if($pics_count>0) {
                                $fotos = explode(",",$params['list']);
                                $this->FieldOutput .= '<div class="inside">';
                                $this->FieldOutput .= '<ul class="gallery_container">';
                                foreach($fotos as $foto){ 
                                    $url_foto = wp_get_attachment_url($foto);
                                    if(substr($url_foto,-8)!='_000.jpg' && substr($url_foto,-9)!='_000p.jpg') {
/*                                        $this->FieldOutput .= '<li class="img_gallery"><a class="thickbox" href="'.$url_foto.'?TB_iframe=true&width=800&height=600">'.wp_get_attachment_image( $foto, array(120,90) ) .'</a></li>';*/
                                        $num = substr($url_foto,strrpos($url_foto,"_")+1,3);
                                        $this->FieldOutput .= '<li class="img_gallery" data-id="'.$foto.'" title='.$num.'>'.wp_get_attachment_image($foto, array(120,90)) .'</li>';
                                    }
                                }
                                $this->FieldOutput .= '</ul>';
                                $this->FieldOutput .= '<p>Total: '.count($fotos).' fotos</p>';
                                $this->FieldOutput .= '</div>';
                            }
                            else $this->FieldOutput .=  '<p>No tienes ninguna foto cargada</p>';
                            $this->FieldOutput .=  '</ul><br></div>';
...
//print_r($meta_user);
		                      ...
		                      $this->FieldOutput .= '
		                           ...
		                           <p>Cualquier pregunta o dudas, llama al teléfono +52 (55) 3455.0138</p><br>
					...
					case 'profile':
						...
						**/
                                ...
                                $opciones = get_referred_list_options();
                                foreach($opciones as $key=>$value){
								...
								$this->FieldOutput .= '
		                               ...
		                               <section>
                                            <label for="userphoto" class="lbl-text">'.esc_html__('Foto del usuario:','pointfindert2d').'<br>'.esc_html__('Dimensiones de la Foto: 200px x 200px (Recomendado)','pointfindert2d').'<br>'.esc_html__('Tipos de archivos admitidos','pointfindert2d').': .jpg, .png, .gif<br>
                                            <span style="color: #ff0000; font-size: 1.2em">'.esc_html__('TAMAÑO MÁXIMO DEL ARCHIVO: 2MB','pointfindert2d').'</span></label>
		                                    <div class="col-lg-3">
		                                    ...
		                                    <span class="goption">
				                                ...
				                                <label for="check1">'.esc_html__('Eliminar las fotos','pointfindert2d').'</label>
				                           </span>
		                                    </div>
		                                    </label>  
		                                    <div class="clearfix"></div>             
		                               ...
		                               ';/*jauregui*/ 
		                               		...
		                               		include("wp-content/themes/pointfinder/vlz/vlz_estados_municipios.php"); // Cambia la ruta relativa para que acceda a este archivo
                                            // Esta aqui: webkmimos/wp-content/themes/pointfinder/vlz/vlz_estados_municipios.php

										    $estados = "";
										    foreach ($estados_municipios as $key => $value) {
										    	if( $usermetaarr['user_state'][0] == $key ){
										        	$estados .= "<option value='{$key}' selected>{$value[0]}</option>";
										    	}else{
										        	$estados .= "<option value='{$key}'>{$value[0]}</option>";
										    	}
										    	if( $usermetaarr['user_country'][0] == $key ){
										        	$municipios .= "<option value='{$key}' selected>{$value[0]}</option>";
										    	}else{
										        	$municipios .= "<option value='{$key}'>{$value[0]}</option>";
										    	}
										    }

										    if( $usermetaarr['user_country'][0] != "" ){
										    	$mun = $usermetaarr['user_country'][0];
										    	foreach ($estados_municipios[ $usermetaarr['user_state'][0] ][1] as $key => $value) {
										    		$municipio_select .= "<option value='$key' ".selected( $key, $mun, false ).">{$value}</option>";
										    	}
										    }else{
										    	$municipio_select = "<option value='{$key}' selected>Seleccione una ciudad primero</option>";
										    }

		                                if (!empty($stp_prf_address)) {
			                                $this->FieldOutput .= '
                                        <section>
                                            <label for="address" class="lbl-text">'.esc_html__('Dirección','pointfindert2d').':</label>
                                            <label class="lbl-ui">
                                                <input type="text" name="address" class="input" value="'.$usermetaarr['user_address'][0].'" />
                                            </label>                          
                                        </section>          
                                        <section>
                                            <label for="country" class="lbl-text">'.esc_html__('País','pointfindert2d').':</label>
                                            <label class="lbl-ui">
                                                <input type="text" name="country" class="input" value="Colombia" disabled/>
                                            </label>
                                        </section>     
		                                <section>
		                                    <label for="user_state" class="lbl-text"><strong>'.esc_html__('Ciudades','pointfindert2d').'(*)</strong>:</label>
		                                    <label class="lbl-ui">
		                                    	<select type="text" id="estados" name="user_state" class="input" onChange="jau_ver_municipios()"  value="'.$usermetaarr['user_state'][0].'" >
		                                ...
		                                <section>
		                                    <label for="user_country" class="lbl-text"><strong>'.esc_html__('Localidades','pointfindert2d').'(*)</strong>:</label>
		                                    <label class="lbl-ui">
		                                    	<select type="text" id="municipios" name="user_country" class="input" value="'.$usermetaarr['user_country'][0].'" />
		                                    		'.$municipio_select.'
		                                    	</select>
		                                    </label>
		                                </section>
		                           ...
		                           <div class="col6 last">
		                               ...
		                               <section>
		                           		...
		                           		<section>
		                                    <label for="webaddr" class="lbl-text">'.esc_html__('Sitio WEB','pointfindert2d').':</label>
		                                    <label class="lbl-ui">
		                                ...
		                                if (!empty($stp_prf_vat)) {
			                                $this->FieldOutput .= '
			                                 <section>
			                                    <label for="vatnumber" class="lbl-text">'.esc_html__('Número de Identidad','pointfindert2d').':</label>
			                                    <label class="lbl-ui">
		                               ...
		                               <section><small><strong style="color: #ff0000;">
		                               		'. esc_html__('ATENCIÓN: ','pointfindert2d').''. esc_html__('La contraseña debe tener minimo 6 caracteres, al menos una letra mayúscula, una minúscula y  un número.','pointfindert2d').'</small>
		                               		</strong>
		                               </section> 
		                           </div>
		                           <div id="pswd_info">
									   <ul>
									      ...
									      <!--<li id="equals">Las contraseñas deben ser iguales</li>-->
									   </ul>
									</div>
								...
								$this->FieldOutput .= '<div class="pfmu-itemlisting-container">';
									...
									*/
									...
									if ( $output_loop->have_posts() ) {
										...
										**/
											$this->FieldOutput .= '<div class="pfmu-itemlisting-htitle pfexhtitle col-lg-2 col-md-2 col-sm-2 hidden-xs">';
											$this->FieldOutput .= esc_html__('Imprimir/ID','pointfindert2d');
											$this->FieldOutput .= '</div>';
											...
											$this->FieldOutput .= '<div class="pfmu-itemlisting-htitle pfexhtitle col-lg-2 col-md-2 col-sm-2 hidden-xs">';
											$this->FieldOutput .= esc_html__('Estado','pointfindert2d');
											$this->FieldOutput .= '</div>';

											$this->FieldOutput .= '<div class="pfmu-itemlisting-htitle pfexhtitle col-lg-2 col-md-2 col-sm-2 hidden-xs">';
											$this->FieldOutput .= esc_html__('Tipo','pointfindert2d');
											$this->FieldOutput .= '</div>';
										...
										while ( $output_loop->have_posts() ) {
											...
											$price_val_inv = get_post_meta( $author_post_id, 'pointfinder_invoice_amount', true );
												...
												switch (get_post_status()) {
													case 'publish':
														$item_post_status_out = esc_html__('Terminado','pointfindert2d');
														break;
													case 'pendingpayment':
														$item_post_status_out = esc_html__('Pago Pendiente','pointfindert2d');
														break;
													case 'pendingapproval':
														$item_post_status_out = esc_html__('Aprobación Pendiente','pointfindert2d');
														break;
													case 'rejected':
														$item_post_status_out = esc_html__('Rechazado','pointfindert2d');
														break;
												}
												...
												$this->FieldOutput .= '<div class="pfmu-itemlisting-inner pf-row clearfix">';
														...
														$this->FieldOutput .= '<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pfmu-itemlisting-title-wd">';
															$this->FieldOutput .= '<div class="pfmu-itemlisting-title pf-review-list">';
																$this->FieldOutput .= '<a href="'.get_permalink().'" style="font-weight:bold" title="'.esc_html__('Ver/Imprimir','pointfindert2d').'" target="_blank" ><i class="pfadmicon-glyph-388"></i> '.$inv_prefix.$author_post_id.'</a>';
															$this->FieldOutput .= '</div>';
					                                    $this->FieldOutput .= '</div>';
