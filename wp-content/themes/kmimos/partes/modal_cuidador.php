<?php 
$HTML .='
	<!-- POPUPS REGISTRARTE COMO CUIDADOR -->
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" id="cuidador" style="    padding: 40px;">
