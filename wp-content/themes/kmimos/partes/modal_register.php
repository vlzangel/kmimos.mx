...
$HTML .='
<div id="modal_registrarte" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		...
		<div class="popup-registrarte-1">
			...
			<a href="#" class="km-btn-fb"><img src="images/icon/km-redes/icon-fb-blanco.svg">REGISTRARME CON FACEBOOK
			</a>
			
			<a href="#" class="km-btn-border"><img src="images/icon/km-redes/icon-gmail.svg">REGISTRARME CON GOOGLE
			</a>
			...
			<a href="#" class="km-btn-correo km-btn-popup-registrarte-1"><img src="images/icon/km-redes/icon-mail-blanco.svg">REGISTRARME POR CORREO ELECTRÓNICO
			</a>
			<p style="color: #979797; margin-top: 20px;">Al crear una cuenta, aceptas las condiciones del servicio y la Política de privacidad de Kmimos.
			</p>
			
			<p><b>Dudas escríbenos</b></p>
			
			<div class="row">
				<div class="col-xs-6 col-sm-4"><p><img style="width: 20px; margin-right: 5px; position: relative; top: -3px;" src="images/icon/km-redes/icon-wsp.svg">Whatsapp</p>
				</div>
				<div class="col-xs-6 col-sm-4"><p><a href="#"><img style="width: 15px; margin-right: 5px; position: relative; top: -1px;" src="images/icon/km-redes/icon-mail.svg">a.vera@kmimos.la</a></p>
				</div>
				<div class="col-xs-12 col-sm-4"><p><img style="width: 12px; margin-right: 5px; position: relative; top: -1px;" src="images/icon/km-redes/icon-cel.svg">(55) 6178 0320</p>
				</div>
			</div>
			<hr>
			<div class="row">
		...
		<div class="popuphide popup-registrarte-nuevo-correo">
			<p style="color: #979797; text-align: center;">
				Regístrate por <a href="#">Facebook</a> o <a href="#">Google</a></a></p>
			<h3 style="margin: 0; text-align: center;">
				Completa tus datos
			</h3>

			<div class="km-box-form" id="form_nuevo_cliente">
				<div class="content-placeholder">
					<div class="label-placeholder">
						<label>Nombre</label>
						<input type="text" name="nombres" id="nombres" class="input-label-placeholder">
					</div>
					<div class="label-placeholder">
						<label>Apellido</label>
						<input type="text" name="apellidos" id="apellidos" class="input-label-placeholder">
					</div>
					<div class="label-placeholder">
						<label>IFE/Documento de Identidad</label>
						<input type="text" name="numid" id="numid" class="input-label-placeholder">
					</div>
					<div class="label-placeholder">
						<label>Correo electrónico</label>
						<input type="text" name="email_1" value="" class="input-label-placeholder">
					</div>
					<div class="label-placeholder">
						<label>Crea tu contraseña</label>
						<input type="password" name="passw" id="passw" value="" class="input-label-placeholder">
					</div>
					<div class="label-placeholder">
						<label>Teléfono</label>
						<input type="text" name="movil" id="movil" value="" class="input-label-placeholder">
					</div>
				</div>
			</div>
		...
		<div class="popuphide popup-registrarte-datos-mascota" id="#datos-mascota">
			...
			<a href="#" class="km-btn-correo km-btn-popup-registrarte-datos-mascota">REGISTRARME
			</a>
			<p style="color: #979797; margin-top: 20px;">Al crear una cuenta, aceptas las condiciones del servicio y la Política de privacidad de Kmimos.</p>
			<p><img style="width: 20px; margin-right: 5px; position: relative; top: -3px;" src="images/icon/km-redes/icon-wsp.svg">En caso de dudas escríbenos al whatsapp</p>
		</div>
