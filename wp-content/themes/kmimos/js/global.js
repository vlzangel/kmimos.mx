...
function tamano(param){
    ...
    $(param).toggleClass('km-opcionactivo');
}

function listarAjax() {
    var ruta = HOME+"../procesos/login/mascota.php";
    __ajax(ruta, "")
    .done(function(info){
...
function guardaDatosUser(){
    var nombre = $("#nombre").val(); 
        ...
        globalData = getGlobalData(HOME+'../procesos/login/registro.php','post', datos); 

        console.log(globalData);
        }else {
            alert("revise sus datos por favor, debe faltar uno");
        }
    ...
    var campos_pet =[nombre_mascota,tipo_mascota,select_mascota,color_mascota,
        ...
        if (nombre_mascota != "" && tipo_mascota != "" && select_mascota != "" && color_mascota !="" 
            && date_from != "" && genero_mascota != "" && tamano_mascota != "") {
               ...
               // console.log(datos);  
               getGlobalData(HOME+'../procesos/login/registro_pet.php','post', datos);
        }else {
            alert("revise sus datos por favor, debe faltar uno");
        }
}
