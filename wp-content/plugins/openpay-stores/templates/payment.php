...
<div class="row">
    ...
    <div class="col-md-4" style="text-align: center;">
        ...
        <p>Haz clic en el botón "<strong>Realizar el pedido</strong>", donde tu compra quedará en espera de que realices tu pago.</p>
    </div>
    <div class="col-md-4" style="text-align: center;">
    ...
    <div class="col-md-4" style="text-align: center;">
        <img alt="" src="<?php echo $this->images_dir ?>step3.png">	
