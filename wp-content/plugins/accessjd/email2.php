...
Recibirás una respuesta de parte de nuestro equipo en un periodo de 24 a 48 horas.<br>
<br>
&nbsp;</p>
                    ...
                    <table class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody><tr>
                            <td class="mcnImageContent" style="padding-right: 9px;padding-left: 9px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" valign="top">
                                        ...
                                        <img alt="" src="http://josedaboin.info/encuesta2/banner_kmimos_800.png" style="max-width: 800px;padding-bottom: 0;display: inline !important;vertical-align: bottom;border: 0;height: auto;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" class="mcnImage" align="middle" width="564">
...
';
        ...
        $email->Subject   = 'Prueba de Conceptos';
        $email->Body      = $message;
		$email->IsHTML(true);  
        $email->AddAddress( $correo_usuario );
        $email->CharSet = 'UTF-8';
        ...
        if(!$email->send()) {
		   ...
		   echo "<script> window.location.replace('../mensaje'); </script>";
		}
 ?>
