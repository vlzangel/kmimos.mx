jQuery(function(a) {
    ...
    var b = {
            ...
            queue_update_checkout: function(a) {
                ...
                return 9 === c || (b.dirtyInput = this, b.reset_update_checkout_timer(), void(b.updateTimer = setTimeout(b.maybe_update_checkout, "1000")))
            },
            ...
            validate_field: function() {
                var b = a(this),
                    ...
                    d = !0;
                if (c.is(".validate-required") && ("checkbox" !== b.attr("type") || b.is(":checked") ? "" === b.val() && (c.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-required-field"), d = !1) : (c.removeClass("woocommerce-validated").addClass("woocommerce-invalid woocommerce-invalid-required-field"), d = !1)), c.is(".validate-email") && b.val()) {
                ...
                if (b.xhr && b.xhr.abort(), 0 !== a("form.checkout").size()) {
                    ...
                    a(".woocommerce-checkout-payment, .woocommerce-checkout-review-order-table").block({
                        ...
                        success: function(c) {
                            ...
                            b.init_payment_methods(), a(document.body).trigger("updated_checkout"), console.log("aqui debe abrir el modal")
                        }
                    })
                }
            },
                    ...
                    1 !== d["blockUI.isBlocked"] && c.block({
                        ...
                        dataFilter: function(b, c) {
                            ...
                            try {
                                ...
                                var e = b.match(/{"result.*"}/);
                                null === e ? console.log("Unable to fix malformed JSON") : (console.log("Fixed malformed JSON. Original:"), console.log(b), b = e[0])
                            }
                            return b
                        }
                    }), a.ajax({
                        ...
                        dataType: "json",
                        success: function(c) {
                            //console.log("Modal procesando <<Jauregui>>");
                            jQuery('#jj_modal_jauregui').hide();
