...
<div class="ls-box ls-settings">
	<h3 class="header medium"><?php _e('Slider Settings WwW.Null24.IR', 'LayerSlider') ?></h3>
	<div class="inner">
		...
		<div class="ls-settings-contents">
			<table>
				...
				<!-- Layout -->
				<tbody class="active">
					<tr><th colspan="3"><?php _e('Slider dimensions - wWw.Null24.IR', 'LayerSlider') ?></th></tr>
					<tr>
					...
					<tr><th colspan="3"><?php _e('Responsive mode - wWw.Null24.IR', 'LayerSlider') ?></th></tr>
					<tr>
				...
				<!-- Slideshow -->
				<tbody>
					<tr><th colspan="3"><?php _e('Slideshow behavior-wWw.Null24.IR', 'LayerSlider') ?></th></tr>
					<tr>
				...
				<tbody>
					...
					<tr><th colspan="3"><?php _e('Thumbnail dimensions-wWw.Null24.IR', 'LayerSlider') ?></th></tr>
					<tr>
