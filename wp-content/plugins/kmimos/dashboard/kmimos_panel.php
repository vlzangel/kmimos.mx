...
$desde = Date("01/m/Y", getDate());
$hasta = Date("d/m/Y", getDate());
			  ...
			  <tbody>
			  	...
			  	<?php foreach( $reservas as $reserva ){ ?>
				    ...
				    <tr>
						...
						<th><?php echo 'Reserva: '.$reserva->estatus_reserva . '  /  Pago: '. $reserva->estatus_pago; ?></th>
						<th><?php echo $reserva->fecha_solicitud; ?></th>
									    ...
									    <div class="thumbnail">
									      ...
									      <div class="caption">
									        ...
									        <div class="row">
									        	...
									        	<span class="col-sm-7"><?php echo $pet['colors']; ?>
									        </div>
									        <div class="row">
