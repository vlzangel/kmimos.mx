...
// Buscar Reservas
$subscribe = getListsubscribe($landing, $desde, $hasta);
?>
...
<div class="x_panel">
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="row text-right"> 
			<div class="col-sm-12">
		    	<form class="form-inline" action="/wp-admin/admin.php?page=bp_subscribe" method="POST">
					<label>Filtrar:</label>
			  ...
			  <tbody>
			  	...
			  	<?php foreach( $subscribe as $row ){ ?>
				  	...
				  	<?php 
				  		...
				  		$result = getUserByEmail($row->email);
				  	?>
				    <tr>
