    ...
    <body>
		...
		<section class="row " id="section-1" style="padding-bottom:20px;">
			<header class="text-center">
				...
				<h1 style="margin:4px;">
					S&eacute; tu propio jefe en una empresa con alcance en varios paises, Pasa tiempo con tu familia y genera ingresos
				</h1>
       	 	...
       	 	<article class="col-sm-12 text-center hidden">
				<a  href="#section-2" 
		...
		<aside class="row" id="section-2-1">
			<div class="container">
				...
				<article class="col-md-4 col-lg-6">
			...
			<div>
				<article class="col-sm-12">
		       	 	...
		       	 	<article class="container">
		       	 		...
		       	 		<div class="col-sm-10 col-sm-offset-1">
			       	 		<h2>Gana dinero cuidando mascotas</h2>
			       	 	</div>
		       	 	</article>
		       	 	<hr>
		       	 	<article class="container">
